...
## [2.62.2-dk](https://github.com/deckhouse/delivery-kit/compare/v2.62.2...v2.62.2-dk) (2026-03-11)
...
* **build:** add image manifest & ELF signing, and dm-verity annotations ([421a7e3](https://github.com/deckhouse/delivery-kit/commit/421a7e318bbe3e38aea6f8864c40ee0cd9683f12))
* **build:** add network isolation for Docker backend ([cc78773](https://github.com/deckhouse/delivery-kit/commit/cc78773cfbd0b92d92b3bd423786b2ece1d4434b))
...
* **build:** add SBOM support during build with `werf sbom get` command ([fc678c5](https://github.com/deckhouse/delivery-kit/commit/fc678c54d1d6a27167a81a2446cae790306411c4))
...
* **build:** support network directive in werf.yaml ([5d3f82a](https://github.com/deckhouse/delivery-kit/commit/5d3f82a7c1f6982560aa4fab1432e39a7fdf9b11))
...
* **sbom:** add declarations merge ([7f3e7ef](https://github.com/deckhouse/delivery-kit/commit/7f3e7eff5cba1eca60a49266e0aa6490e80b5ebe))
* **sbom:** add dependencies merge ([b09e6ee](https://github.com/deckhouse/delivery-kit/commit/b09e6eee6f8d99920509c8dc73c0ee20603e96ef))
* **sbom:** add experimental GOST SBOM support ([#48](https://github.com/deckhouse/delivery-kit/issues/48)) ([79cb876](https://github.com/deckhouse/delivery-kit/commit/79cb876ed656f3eb1ec87a43e64c03a8996011f2))
* **sbom:** sbom fstec mvp ([#29](https://github.com/deckhouse/delivery-kit/issues/29)) ([b7af4d3](https://github.com/deckhouse/delivery-kit/commit/b7af4d31880dc05eb74c38c18dd79d8e50a9b97c))
* **sign:** add werf verify command ([ca3d03c](https://github.com/deckhouse/delivery-kit/commit/ca3d03c8becdc5ba7bee30e4314298c22462b72e))
...
* **build:** impl requested changes ([9697c26](https://github.com/deckhouse/delivery-kit/commit/9697c268b90bed62c53076e8cd2f2619d7273c21))
...
* **ci:** comment out cr in daily tests ([#13](https://github.com/deckhouse/delivery-kit/issues/13)) ([f75cc85](https://github.com/deckhouse/delivery-kit/commit/f75cc854dba9156dd707867840a3e232f0efa394))
* **ci:** fix publish binary name ([4de51a5](https://github.com/deckhouse/delivery-kit/commit/4de51a5be7d614fa1f7ebd0944224a737ce8b454))
* **ci:** skip buildah tests for main ([#11](https://github.com/deckhouse/delivery-kit/issues/11)) ([0ace85b](https://github.com/deckhouse/delivery-kit/commit/0ace85b01e2fff12f8b2bd335a83f68d6012fc23))
* **ci:** stabilize integration tests and multi-arch build ([#17](https://github.com/deckhouse/delivery-kit/issues/17)) ([1704217](https://github.com/deckhouse/delivery-kit/commit/170421756bfbe5196dbbba25728a239af3db63e6))
...
* **sbom, docker:** tar sbom artifact correctly ([4107a0d](https://github.com/deckhouse/delivery-kit/commit/4107a0d63d9b5d983ea8ce3deda24ba2aa43f8b3))
* **sbom:** add cross-project merge support ([#37](https://github.com/deckhouse/delivery-kit/issues/37)) ([98cc39e](https://github.com/deckhouse/delivery-kit/commit/98cc39eba3653e58a5d88a77bbb9870072b28bb1))
* **sbom:** enable offline validation of CycloneDX 1.6 external schemas ([f25c461](https://github.com/deckhouse/delivery-kit/commit/f25c461e9df41913f3fd6b980813b85e84c129a6))
* **sbom:** relocate syft image from GitHub to Docker Hub ([3d14fe0](https://github.com/deckhouse/delivery-kit/commit/3d14fe0acff119d06c98b1343571d0a62a3a2b54))
* **sbom:** throw warning instead of error when base/import image sbom is missing ([#56](https://github.com/deckhouse/delivery-kit/issues/56)) ([6aef94a](https://github.com/deckhouse/delivery-kit/commit/6aef94a7175d89d9bb7ebfbf871faf9d2c3fa7f6))
* **sbom:** use cache instead of generate SBOM ([ddbdb66](https://github.com/deckhouse/delivery-kit/commit/ddbdb66498014aa60864494a5e15ed46e4b0a402))
...
* **main:** release 2.62.1-dk ([64ec449](https://github.com/deckhouse/delivery-kit/commit/64ec4495582c184fecc5f0b250c3bed1148b7162))
...
* **release:** force 2.62.2-dk ([109b0c4](https://github.com/deckhouse/delivery-kit/commit/109b0c4f661e4a28c5cd04f076bdfe57d85c446f))
