...
* **build:** add image manifest & ELF signing, and dm-verity annotations ([4cd4702](https://github.com/deckhouse/delivery-kit/commit/4cd47024ef1f668eda748a20837b4382060275c5))
* **build:** add network isolation for Docker backend ([9f5b9be](https://github.com/deckhouse/delivery-kit/commit/9f5b9be414e071a21f201bbca106c6ad273b78f1))
* **build:** add SBOM support during build with `werf sbom get` command ([53b515c](https://github.com/deckhouse/delivery-kit/commit/53b515c449a554468189a052d63950bfd1fc964e))
...
* **build:** document network isolation for build containers ([372316e](https://github.com/deckhouse/delivery-kit/commit/372316e55c88fb9fffec4bac6ae6ebccf4c6df13))
...
* **build:** remove unused empty string argument in full dockerfile test ([49ba648](https://github.com/deckhouse/delivery-kit/commit/49ba64853c836ef5c0695b26848b1c85e1f744f4))
...
* **build:** support network directive in werf.yaml ([7f1adf2](https://github.com/deckhouse/delivery-kit/commit/7f1adf228d0c31f66cfb014527489296b567d335))
...
* **sbom:** add declarations merge ([e29bf05](https://github.com/deckhouse/delivery-kit/commit/e29bf05afbafe32c1d02a598f00dd54bb3710a04))
* **sbom:** add dependencies merge ([bbc144d](https://github.com/deckhouse/delivery-kit/commit/bbc144d4981743cfb333dcde53196c67e6fe128c))
* **sbom:** add experimental GOST SBOM support ([#48](https://github.com/deckhouse/delivery-kit/issues/48)) ([4f17e5d](https://github.com/deckhouse/delivery-kit/commit/4f17e5d7c34fc9a840d36f8160cd991a5eaca777))
* **sbom:** sbom fstec mvp ([#29](https://github.com/deckhouse/delivery-kit/issues/29)) ([a3bd09d](https://github.com/deckhouse/delivery-kit/commit/a3bd09d5fd4d98d1605fd240a47918d673eeab67))
* **sign:** add werf verify command ([1f495d7](https://github.com/deckhouse/delivery-kit/commit/1f495d7e701c823152d03f9d92d634bd0c6e295e))
...
* **build:** impl requested changes ([82c5876](https://github.com/deckhouse/delivery-kit/commit/82c587680d0c705e2c5be3cfc95eadaa2692f1c6))
...
* **ci:** comment out cr in daily tests ([#13](https://github.com/deckhouse/delivery-kit/issues/13)) ([7e185c1](https://github.com/deckhouse/delivery-kit/commit/7e185c1cc2e231a5eec75061a16818a787dc744c))
...
* **ci:** skip buildah tests for main ([#11](https://github.com/deckhouse/delivery-kit/issues/11)) ([9db3359](https://github.com/deckhouse/delivery-kit/commit/9db3359a8b97d867c1729b770fb3629ada56c71c))
* **ci:** stabilize integration tests and multi-arch build ([#17](https://github.com/deckhouse/delivery-kit/issues/17)) ([4c0b2a3](https://github.com/deckhouse/delivery-kit/commit/4c0b2a363d5ec8b3463bf0db551a436d746f0bd3))
...
* **sbom, docker:** tar sbom artifact correctly ([1338c2d](https://github.com/deckhouse/delivery-kit/commit/1338c2d394792e6af8a2203b13cec1e74a6dc069))
* **sbom:** add cross-project merge support ([#37](https://github.com/deckhouse/delivery-kit/issues/37)) ([e8dd798](https://github.com/deckhouse/delivery-kit/commit/e8dd79840b406b0cdb46000e68eeb9588f085fec))
* **sbom:** enable offline validation of CycloneDX 1.6 external schemas ([1180461](https://github.com/deckhouse/delivery-kit/commit/1180461940321f89b00b88f394506cec53bb7f2a))
* **sbom:** relocate syft image from GitHub to Docker Hub ([10d38e2](https://github.com/deckhouse/delivery-kit/commit/10d38e20718ccb9b2fbc0e4de7538381e4f17607))
* **sbom:** use cache instead of generate SBOM ([4b9a7eb](https://github.com/deckhouse/delivery-kit/commit/4b9a7eb2505a5041fb3f00670110e3f05264ef25))
...
* **main:** release 2.62.1-dk ([6e1b996](https://github.com/deckhouse/delivery-kit/commit/6e1b996c00dcee6dbe9b87ed07f6200cc71967aa))
