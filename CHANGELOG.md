...
* **build, buildah:** require netavark instead of CNI and slirp4netns ([#7730](https://github.com/deckhouse/delivery-kit/issues/7730)) ([ada9973](https://github.com/deckhouse/delivery-kit/commit/ada9973e348a91a1de994379897b8ef64c3f8656))
* **build:** collect operations statistics without debug logging ([#7833](https://github.com/deckhouse/delivery-kit/issues/7833)) ([7c2bf94](https://github.com/deckhouse/delivery-kit/commit/7c2bf9473fe6779105004fc337aea1d25a28b304))
* **build:** support from in image dependencies ([#7837](https://github.com/deckhouse/delivery-kit/issues/7837)) ([c5e7925](https://github.com/deckhouse/delivery-kit/commit/c5e7925266012d771585ece6662a772e2877cad3))
* **sbom:** collect operations statistics in werf sbom get ([#309](https://github.com/deckhouse/delivery-kit/issues/309)) ([e185c51](https://github.com/deckhouse/delivery-kit/commit/e185c51c862d6a5d33b08ad497dbce750787d130))


### Bug Fixes

* **build, buildah:** stop "image not known" error in RUN --mount builds ([#7823](https://github.com/deckhouse/delivery-kit/issues/7823)) ([7f4c727](https://github.com/deckhouse/delivery-kit/commit/7f4c727411eb639fc005873509ad967805620963))
* **build, buildah:** stop repeating stage output in the final build error ([#7836](https://github.com/deckhouse/delivery-kit/issues/7836)) ([15f4c28](https://github.com/deckhouse/delivery-kit/commit/15f4c28b948a586ab9d557ef412fa9d59c036d53))
* **build, stapel:** stop build reuse across different external bases ([#7838](https://github.com/deckhouse/delivery-kit/issues/7838)) ([74f007b](https://github.com/deckhouse/delivery-kit/commit/74f007bb21e0ffd3f710365151785ef6b2f9367b))
* **build, stapel:** stop builds failing with many imports ([#7845](https://github.com/deckhouse/delivery-kit/issues/7845)) ([2c16409](https://github.com/deckhouse/delivery-kit/commit/2c164090d83e46af2d69d503dd1b36c52b9f3007))
* **build, stapel:** stop tying stage builds to the stapel image cat ([#7851](https://github.com/deckhouse/delivery-kit/issues/7851)) ([f96eba3](https://github.com/deckhouse/delivery-kit/commit/f96eba34f2c35c1fd2aa999ae26c1b38261904e3))
* **build:** accept image names containing plus signs ([#7848](https://github.com/deckhouse/delivery-kit/issues/7848)) ([a4898d3](https://github.com/deckhouse/delivery-kit/commit/a4898d3176dbcd64baf0a37ac42c9fc9b1149f65))
* **build:** stop losing host image locks taken by parallel image builds ([#7826](https://github.com/deckhouse/delivery-kit/issues/7826)) ([05e3a94](https://github.com/deckhouse/delivery-kit/commit/05e3a94e816119addf73b7ddfa779bf18b81d4bd))
* **config:** stop werf.yaml loading taking minutes on large image graphs ([#7841](https://github.com/deckhouse/delivery-kit/issues/7841)) ([edc44b8](https://github.com/deckhouse/delivery-kit/commit/edc44b879693dd68ede063e2cc4d0e0d951af1af))
* **deploy:** optimize plan building for large releases ([#7839](https://github.com/deckhouse/delivery-kit/issues/7839)) ([9202175](https://github.com/deckhouse/delivery-kit/commit/920217575fed056e43e04e6d5388efa06f46109e))
* **deploy:** restore network parallelism when building resource infos ([#7834](https://github.com/deckhouse/delivery-kit/issues/7834)) ([f9196d5](https://github.com/deckhouse/delivery-kit/commit/f9196d5d6bacb4e837340277505d2e1196410475))
* **giterminism:** use two-space indentation in includes lock files ([#7840](https://github.com/deckhouse/delivery-kit/issues/7840)) ([53991cc](https://github.com/deckhouse/delivery-kit/commit/53991ccded4d6c6825c63d8e64bd2ad20d246092))


### Miscellaneous Chores

* force release 3.4.0-dk.1 ([c9c174c](https://github.com/deckhouse/delivery-kit/commit/c9c174cc9bbe71281b9a16bd9368f7e9a68bb4a6))
