...
var _ = ginkgo.Describe("rawStageDependencies", func() {
	ginkgo.DescribeTable("preserves the difference between an absent stage and an explicit empty list",
		func(gitYaml string, install, beforeSetup, setup, packages []string) {
			...
			gomega.Expect(stageDependencies.Packages).To(gomega.Equal(packages))
		},
		ginkgo.Entry("only beforeSetup masks",
			"- add: /\n  to: /app\n  stageDependencies:\n    beforeSetup: [\"src/**/*\"]\n",
			nil, []string{"src/**/*"}, nil, nil,
		),
		ginkgo.Entry("install and setup masks",
			"- add: /\n  to: /app\n  stageDependencies:\n    install: [\"package.json\", \"package-lock.json\"]\n    setup: [\"src/**/*\"]\n",
			[]string{"package.json", "package-lock.json"}, nil, []string{"src/**/*"}, nil,
		),
		ginkgo.Entry("only install masks",
			"- add: /\n  to: /app\n  stageDependencies:\n    install: [\"package-lock.json\"]\n",
			[]string{"package-lock.json"}, nil, nil, nil,
		),
		ginkgo.Entry("only packages masks",
			"- add: /\n  to: /app\n  stageDependencies:\n    packages: [\"go.mod\", \"go.sum\"]\n",
			nil, nil, nil, []string{"go.mod", "go.sum"},
		),
		...
		ginkgo.Entry("explicit empty packages",
			"- add: /\n  to: /app\n  stageDependencies:\n    packages: []\n",
			nil, nil, nil, []string{},
		),
		...
		ginkgo.Entry("all stages declared, masks and empty lists mixed",
			"- add: /\n  to: /app\n  stageDependencies:\n    install: []\n    beforeSetup: [\"src/**/*\"]\n    setup: []\n    packages: [\"go.mod\"]\n",
			[]string{}, []string{"src/**/*"}, []string{}, []string{"go.mod"},
		),
		ginkgo.Entry("yaml keys in reverse stage order",
			"- add: /\n  to: /app\n  stageDependencies:\n    packages: []\n    setup: []\n    beforeSetup: [\"src/**/*\"]\n    install: []\n",
			[]string{}, []string{"src/**/*"}, []string{}, []string{},
		),
		ginkgo.Entry("scalar mask instead of a list",
			"- add: /\n  to: /app\n  stageDependencies:\n    install: package.json\n",
			[]string{"package.json"}, nil, nil, nil,
		),
		ginkgo.Entry("scalar packages mask instead of a list",
			"- add: /\n  to: /app\n  stageDependencies:\n    packages: go.mod\n",
			nil, nil, nil, []string{"go.mod"},
		),
	)
	...
	ginkgo.DescribeTable("rejects invalid stage dependencies",
		...
		ginkgo.Entry("absolute packages path",
			"- add: /\n  to: /app\n  stageDependencies:\n    packages: [\"/go.mod\"]\n",
			"`packages: [PATH, ...]|PATH` should be relative paths!",
		),
