...
var _ = Describe("Image", func() {
	DescribeTable("IsScratchRef",
		...
		Entry("bare scratch", "scratch", false),
		Entry("empty string", "", false),

		Entry("localhost scratch with tag", "localhost:5000/scratch:latest", false),
		Entry("localhost scratch with digest", "localhost:5000/scratch@sha256:abc123def456abc123def456abc123def456abc123def456abc123def456abc1", false),
