...
- Status of implementation at the time of writing: US1 (FR-001…FR-006) and US2 (FR-007) are implemented in this branch; US3 (FR-008…FR-011, the extraction into a dedicated SBOM subpackage) is the remaining work requested during review of PR #268.
