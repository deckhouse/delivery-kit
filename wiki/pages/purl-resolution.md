...
See also: [ComponentError type](./component-error-type.md), [error detection sentinel](./error-detection-sentinel.md), [error aggregation strategy](./error-aggregation-strategy.md).